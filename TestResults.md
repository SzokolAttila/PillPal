...
| I/84 | Automated | Integration | ActiveIngredientAPITests | CannotAddActiveIngredientToNonExistantMedicine | Trying to add an active ingredient with a medicine id that cannot be found results in an exception | 2025-01-11 | 135 ms | Passed |
...
| I/86 | Automated | Integration | ActiveIngredientAPITests | CannotDeleteNonExistantActiveIngredient | Trying to delete an active ingredinet that doesn't exist will throw a Not Found exception | 2025-01-11 | 144 ms | Passed |
| I/87 | Automated | Integration | ActiveIngredientAPITests | CannotEditNonExistantActiveIngredient | Trying to update an active ingredinet that doesn't exist will throw a Not Found exception | 2025-01-11 | 132 ms | Passed |
