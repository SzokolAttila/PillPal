...
| I/92 | Automated | Integration | RemedyForAPITests | CannotAddRemedyForToNonExistantMedicine | Trying to add a remedyFor to a medicine that doesn't exist will result in an exception | 2025-01-11 | 127 ms | Passed |
