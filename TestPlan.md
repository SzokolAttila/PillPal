...
| Integration test | Putting user with changed long password throws exception | Create admin and user, post them and login with admin | Modify user's password to long, then put it | Throws argument exception with validator's message |
